...
(function () {
  ...
  this.getRawRainData = function () {
    ...
    return Promise.resolve('130|'+`${date.getHours()}:${date.getMinutes()}`+' 130|11:55 130|12:00 130|12:05 130|12:10 100|12:15  170|13:25 077|13:20 077|13:20 077|13:20 077|13:20 077|13:20 077|13:20 077|13:20 000|13:30 000|13:35 000|13:40 000|13:45 000|13:50 000|13:30 000|13:35 000|13:40 000|13:45 000|13:50 000|13:30 000|13:35 000|13:40 077|13:45 077|13:50 077|13:50 077|13:50')
    return new Promise((resolve, reject) => {
      const req = http.request(
        {
          host: 'gratisweerdata.buienradar.nl',
  ...
  this.getRainData = function () {
    ...
    if (this.requestCacheTimeout && rainDataCache) {
      return Promise.resolve(rainDataCache);
    } else {
      return rainDataCache = this.getRawRainData().then(data => {
        return new Promise(resolve => {
          ...
          if (this.requestCacheTimeout) {
            setTimeout(() => rainDataCache = null, this.requestCacheTimeout);
          }
        });
      });
    }
